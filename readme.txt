...
Это приложение позволяет пользователям создавать и просматривать свои заметки. Оно использует Django для бэкенда и HTML, CSS и JavaScript для интерфейса.
...
### Функции:
 ...
 Удаление заметок: Пользователи могут удалять свои заметки.
